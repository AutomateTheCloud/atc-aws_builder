#!/bin/bash
###------------------------------------------------------------------------------------------------
# alias:   aws_builder.ssm.parameter_put_file_multi_part
# script:  parameter_put_file_multi_part.sh
...
###------------------------------------------------------------------------------------------------
## Config
declare -r SELF_IDENTITY="parameter_put_file_multi_part"
declare -r SELF_IDENTITY_H="Parameter (Put File Multi-Part)"
...
parameter_put_file_multi_part "${PARAMETER_NAME}" "${FILE_TARGET}" "${ENCRYPTION_KEY}" "${DESCRIPTION}" "${REPLACE_PARAMETER}" "${AWS_REGION}"
RETURNVAL="$?"
## END Execution
###------------------------------------------------------------------------------------------------
